        ...
        <h5 className="section-tag">USER STORIES</h5>
          <div className="three-col">
            ...
            <div className="user-story-lt-rt">
              ...
              <a className="img-user-story" href="https://www.youtube.com/watch?v=hNHAz6Km-j0&list=PLKqaoAnDyfgolzgeREuKrvsPJhQLTt_he&index=5&t=668s"><img className="img-user-story" src={Atalaya} /></a>
                </div>
            ...
            <div className="user-story-middle">
              <div className="img-container-user-story">
              <a className="img-user-story" href="https://github.com/magma/magma"><img className="img-user-story" src={Charity} /></a>
                </div>
            ...
            <div className="user-story-lt-rt">
              <div className="img-container-user-story">
              <a className="img-user-story" href="https://www.youtube.com/watch?v=VybSCeTPf88&list=PLKqaoAnDyfgolzgeREuKrvsPJhQLTt_he&index=13&t=917s"><img className="img-user-story" src={Kamol} /></a>
                </div>
